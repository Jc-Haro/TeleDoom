...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompisteParts = false)
        {
            InputBinding newBinding = action.bindings[bindingIndex];
        ...
        [SerializeField]
        public bool m_ActionLabelOverride;

        [Tooltip("String that will be displayed in action label")]
        [SerializeField]

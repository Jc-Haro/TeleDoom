...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_InputInUseProperty = serializedObject.FindProperty("m_InputInUse");
            ...
            m_ActionOverRideProperty = serializedObject.FindProperty("m_ActionLabelOverride");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_InputInUseProperty);
            }
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                if (m_RebindActionUI.m_ActionLabelOverride)
                {
        ...
        private SerializedProperty m_InputInUseProperty;
        ...
        private GUIContent m_CustomizeUILabel = new GUIContent("Customize UI Label");
